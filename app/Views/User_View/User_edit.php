                        ...
                        <div class="card-body">
                            ...
                            <div class="row justify-content-center">
                                <div class="form col-md-8 mt-5 ">
                                    ...
                                    <form method="post" action="<?=base_url('/user/save_edit/'.$editdata['id']) ;?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                placeholder="Nama Barang..." value="<?= $editdata['nama_barang'] ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="dropify" data-max-file-size="1M" id="lampiran" 
                                                name="lampiran" required value="<?= $editdata['lampiran'] ?>" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="" data-a-sign="Rp. "
                                                ...
                                                placeholder="Tanggal keberangkatan..." value="<?= $editdata['biaya'] ?>" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="catatan" id="catatan" rows="3"
                                                placeholder="Berikan Catatan anda..." value="<?=$editdata['catatan'] ?>">  <?=$editdata['catatan'] ?> </textarea>
